...
/** Owner of every social profile in {@link SOCIALS} — appended to the
 *  aria-label of each link as `${platform} — ${SOCIAL_OWNER}`. */
export const SOCIAL_OWNER = "Patrick Patenaude";
